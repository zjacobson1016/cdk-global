...
# MAGIC %md
# MAGIC Wait/Verify that the monitor was created
...
# MAGIC %md
# MAGIC Monitor creation for the first time will also **trigger an initial refresh** so fetch/wait or trigger a monitoring job and wait until completion
